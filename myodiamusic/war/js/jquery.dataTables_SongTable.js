			...
			"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				$(nNext).bind( 'click.DT', function() {
					if ( oSettings.oApi._fnPageChange( oSettings, "next" ) )
					{
						...
						if(document.getElementById("songTable").getElementsByTagName("tr").length < 5){
								return;
						}
						...
						function structingSongInRowWithJtable(songDataList){
							...
							temp = songDataTable.fnSettings().aoData.length;
							alert(temp)
							var dataIndex = temp; 
							$.each(songDataList, function(index, songDataList) {
								  
								   newRow[0]="<input name='sharebutton' type='button' id='" + songDataList.songId + "' value='shareWithSocial'>";
								   ...
								   newRow[4]=songImage;
								   newRow[5]="<input name='PlayButton' type='button' id='" + songDataList.songId + "' value='Play'>";
